  ...
  <div class="addEdit-block">
    <el-form class="detail-form-content" ref="ruleForm" :model="ruleForm" :rules="rules" label-width="80px"
      ...
      <el-row>
        ...
        <el-col :span="12">
          <el-form-item class="select" v-if="type != 'info'" label="Gender" prop="gender">
          ...
          <div v-else>
            <el-form-item class="input" label="Gender" prop="gender">
              <el-input v-model="ruleForm.gender" placeholder="Gender" readonly></el-input>
            </el-form-item>
          </div>
        </el-col>
        <el-col :span="12">
          <el-form-item class="date" v-if="type != 'info'" label="Birthday" prop="birthday">
            <el-date-picker format="yyyy-MM-dd" value-format="yyyy-MM-dd" v-model="ruleForm.birthday" type="date"
              placeholder="Birthday">
            </el-date-picker>
          </el-form-item>
          <div v-else>
            <el-form-item class="input" v-if="ruleForm.birthday" label="Birthday" prop="birthday">
              <el-input v-model="ruleForm.birthday" placeholder="Birthday" readonly></el-input>
            </el-form-item>
          </div>
        </el-col>
        <el-col :span="12">
          <el-form-item class="input" v-if="type != 'info'" label="ID Number" prop="identificationNumber">
            <el-input v-model="ruleForm.identificationNumber" placeholder="ID Number" clearable
              :readonly="ro.identificationNumber"></el-input>
          </el-form-item>
          <div v-else>
            <el-form-item class="input" label="ID Number" prop="identificationNumber">
              <el-input v-model="ruleForm.identificationNumber" placeholder="ID Number" readonly></el-input>
            </el-form-item>
          </div>
        </el-col>
        <el-col :span="12">
      ...
      <el-row>
        <el-col :span="24">
          <el-form-item v-if="type != 'info'" label="Photos (ID/License)" prop="returnContent">
            <editor style="min-width: 200px; max-width: 600px;" v-model="ruleForm.photo" class="editor"
              action="file/upload">
            </editor>
          </el-form-item>
          <div v-else>
            <el-form-item label="Photos (ID/License)" prop="returnContent">
...
<script>
// number, email, mobile, url, ID validation
      ...
      if (this.type == 'info' || this.type == 'else') {
        ...
        for (var o in obj) {
          ...
          if (o == 'birthday') {
            ...
            this.ro.birthday = true;
            continue;
          }
          if (o == 'identificationNumber') {
            this.ruleForm.identificationNumber = obj[o];
            this.ro.identificationNumber = true;
            continue;
          }
          if (o == 'mobilePhone') {
