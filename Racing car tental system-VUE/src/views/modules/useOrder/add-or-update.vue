  ...
  <div class="addEdit-block">
    <el-form class="detail-form-content" ref="ruleForm" :model="ruleForm" :rules="rules" label-width="80px"
      ...
      <el-row>
        ...
        <el-col :span="12">
          <el-form-item class="input" v-if="type != 'info'" label="Duration" prop="useDuration">
            <el-input v-model="ruleForm.useDuration" placeholder="Duration (hours)" clearable :readonly="ro.useDuration"></el-input>
          </el-form-item>
          <div v-else>
            <el-form-item class="input" label="Duration" prop="useDuration">
              <el-input v-model="ruleForm.useDuration" placeholder="Duration" readonly></el-input>
            </el-form-item>
          </div>
        </el-col>
        <el-col :span="12">
          <el-form-item class="input" v-if="type != 'info'" label="Total Price" prop="totalPrice">
            <el-input v-model="totalPrice" placeholder="Total Price" readonly></el-input>
          </el-form-item>
          <div v-else>
            <el-form-item class="input" v-if="ruleForm.totalPrice" label="Total Price" prop="totalPrice">
              <el-input v-model="ruleForm.totalPrice" placeholder="Total Price" readonly></el-input>
            </el-form-item>
          </div>
        </el-col>
        <el-col :span="12">
          <el-form-item class="date" v-if="type != 'info'" label="Use Time" prop="useTime" width="200">
            <el-date-picker value-format="yyyy-MM-dd HH:mm:ss" v-model="ruleForm.useTime" type="datetime"
              placeholder="Use Time">
            </el-date-picker>
          </el-form-item>
          <div v-else>
            <el-form-item class="input" v-if="ruleForm.useTime" label="Use Time" prop="useTime">
              <el-input v-model="ruleForm.useTime" placeholder="Use Time" readonly></el-input>
            </el-form-item>
          </div>
        </el-col>
        <el-col :span="12">
        ...
        <el-col :span="12">
          <el-form-item class="input" v-if="type != 'info'" label="Name" prop="realName">
            <el-input v-model="ruleForm.realName" placeholder="Name" clearable :readonly="ro.realName"></el-input>
          </el-form-item>
          <div v-else>
            <el-form-item class="input" label="Name" prop="realName">
              <el-input v-model="ruleForm.realName" placeholder="Name" readonly></el-input>
            </el-form-item>
          </div>
        </el-col>
        <el-col :span="12">
          <el-form-item class="input" v-if="type != 'info'" label="Mobile" prop="mobilePhone">
            <el-input v-model="ruleForm.mobilePhone" placeholder="Mobile" clearable :readonly="ro.mobilePhone"></el-input>
          </el-form-item>
          <div v-else>
            <el-form-item class="input" label="Mobile" prop="mobilePhone">
              <el-input v-model="ruleForm.mobilePhone" placeholder="Mobile" readonly></el-input>
            </el-form-item>
          </div>
        </el-col>
      </el-row>
...
export default {
  ...
  computed: {
    totalPrice: {
      get: function () {
        return 1 * this.ruleForm.hourlyPrice * this.ruleForm.useDuration
      }
    },
  },
  created() {
    this.ruleForm.useTime = this.getCurDateTime()
  ...
  methods: {
    ...
    init(id, type) {
      ...
      if (this.type == 'info' || this.type == 'else') {
        ...
        for (var o in obj) {
          ...
          if (o == 'useDuration') {
            this.ruleForm.useDuration = obj[o];
            this.ro.useDuration = true;
            continue;
          }
          if (o == 'totalPrice') {
          ...
          if (o == 'useTime') {
            this.ruleForm.useTime = obj[o];
            this.ro.useTime = true;
            continue;
          }
          if (o == 'username') {
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `useOrder/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.useOrderCrossAddOrUpdateFlag = false;
