  ...
  <div class="addEdit-block">
    <el-form class="detail-form-content" ref="ruleForm" :model="ruleForm" :rules="rules" label-width="80px"
      ...
      <el-row>
        ...
        <el-col :span="12">
          <el-form-item class="input" v-if="type != 'info'" label="Body Color" prop="bodyColor">
            <el-input v-model="ruleForm.bodyColor" placeholder="Body Color" clearable :readonly="ro.bodyColor"></el-input>
          </el-form-item>
          <div v-else>
            <el-form-item class="input" label="Body Color" prop="bodyColor">
              <el-input v-model="ruleForm.bodyColor" placeholder="Body Color" readonly></el-input>
            </el-form-item>
          </div>
        </el-col>
        <el-col :span="12">
        ...
        <el-col :span="12">
          <el-form-item class="input" v-if="type != 'info'" label="Hourly Price" prop="hourlyPrice">
            <el-input v-model="ruleForm.hourlyPrice" placeholder="Hourly Price" clearable :readonly="ro.hourlyPrice"></el-input>
          </el-form-item>
          <div v-else>
            <el-form-item class="input" label="Hourly Price" prop="hourlyPrice">
              <el-input v-model="ruleForm.hourlyPrice" placeholder="Hourly Price" readonly></el-input>
            </el-form-item>
          </div>
        </el-col>
        <el-col :span="12">
          <el-form-item class="select" v-if="type != 'info'" label="Dispense Area" prop="dispenseRegion">
            <el-select v-model="ruleForm.dispenseRegion" placeholder="Select dispense area">
              <el-option v-for="(item, index) in toufangdiquOptions" v-bind:key="index" :label="item" :value="item">
              </el-option>
            </el-select>
          </el-form-item>
          <div v-else>
            <el-form-item class="input" label="Dispense Area" prop="dispenseRegion">
              <el-input v-model="ruleForm.dispenseRegion" placeholder="Dispense Area" readonly></el-input>
            </el-form-item>
          </div>
        </el-col>
        <el-col :span="12">
          <el-form-item class="input" v-if="type != 'info'" label="Location" prop="dispenseLocation">
            <el-input v-model="ruleForm.dispenseLocation" placeholder="Dispense Location" clearable
              :readonly="ro.dispenseLocation"></el-input>
          </el-form-item>
          <div v-else>
            <el-form-item class="input" label="Location" prop="dispenseLocation">
              <el-input v-model="ruleForm.dispenseLocation" placeholder="Dispense Location" readonly></el-input>
            </el-form-item>
          </div>
        </el-col>
        <el-col :span="12">
          <el-form-item class="date" v-if="type != 'info'" label="Dispense Time" prop="dispenseTime">
            <el-date-picker value-format="yyyy-MM-dd HH:mm:ss" v-model="ruleForm.dispenseTime" type="datetime" width="200"
              placeholder="Dispense Time">
            </el-date-picker>
          </el-form-item>
          <div v-else>
            <el-form-item class="input" v-if="ruleForm.dispenseTime" label="Dispense Time" prop="dispenseTime">
              <el-input v-model="ruleForm.dispenseTime" placeholder="Dispense Time" readonly></el-input>
            </el-form-item>
          </div>
        </el-col>
        <el-col :span="12">
          <el-form-item class="select" v-if="type != 'info'" label="Car Status" prop="carCondition">
            <el-select v-model="ruleForm.carCondition" placeholder="Select car status">
              <el-option v-for="(item, index) in cheliangzhuangtaiOptions" v-bind:key="index" :label="item" :value="item">
              </el-option>
            </el-select>
          </el-form-item>
          <div v-else>
            <el-form-item class="input" label="Car Status" prop="carCondition">
              <el-input v-model="ruleForm.carCondition" placeholder="Car Status" readonly></el-input>
            </el-form-item>
          </div>
        </el-col>
      </el-row>
...
export default {
  data() {
    ...
    return {
      ...
      ro: {
        ...
        hourlyPrice: false,
        dispenseRegion: false,
        dispenseLocation: false,
        dispenseTime: false,
        carCondition: false,
      },
      ruleForm: {
      ...
      rules: {
        ...
        hourlyPrice: [
          { required: true, message: 'Hourly price cannot be empty', trigger: 'blur' },
  ...
  created() {
    this.ruleForm.dispenseTime = this.getCurDateTime()
  ...
  methods: {
    ...
    init(id, type) {
      ...
      if (this.type == 'info' || this.type == 'else') {
        ...
        for (var o in obj) {
          ...
          if (o == 'hourlyPrice') {
            this.ruleForm.hourlyPrice = obj[o];
            this.ro.hourlyPrice = true;
            continue;
          }
          if (o == 'dispenseRegion') {
            this.ruleForm.dispenseRegion = obj[o];
            this.ro.dispenseRegion = true;
            continue;
          }
          if (o == 'dispenseLocation') {
            this.ruleForm.dispenseLocation = obj[o];
            this.ro.dispenseLocation = true;
            continue;
          }
          if (o == 'dispenseTime') {
            this.ruleForm.dispenseTime = obj[o];
            this.ro.dispenseTime = true;
            continue;
          }
          if (o == 'carCondition') {
            this.ruleForm.carCondition = obj[o];
            this.ro.carCondition = true;
            continue;
          }
        }
      }
      ...
      this.cheliangzhuangtaiOptions = "Available,In Use".split(',')
    },
    // 多级联动参数
    info(id) {
      this.$http({
        url: `carDispense/info/${id}`,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
    ...
    onSubmit() {
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `carDispense/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
    ...
    back() {
      this.parent.showFlag = true;
      this.parent.addOrUpdateFlag = false;
      this.parent.carReturnCrossAddOrUpdateFlag = false;
      this.parent.contentStyleChange();
    },
    addEditStyleChange() {
      this.$nextTick(() => {
